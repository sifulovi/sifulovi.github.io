...
হোমপেজে **নতুন তারিখ আগে** দেখায়। শেখার ক্রম ঠিক রাখতে সব পোস্টের তারিখ একই রেখে **সময় অবরোহী** করা হয়েছে —
`sql` = ২২:০০, `database-management-system` = ২১:০০, ... `kubernetes` = ১১:০০। সূচিপত্র পোস্টটা ২৩:০০ **এবং** `pin: true`।

নতুন পোস্ট মাঝখানে ঢোকাতে চাইলে তার সময়টা সেই অনুযায়ী দিন।
